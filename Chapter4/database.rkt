...
(define assertions '((assert! (address (Bitdiddle Ben) (Slumerville (Ridge Road) 10)))
		     ...
		     (assert! (job (Tweakit Lem E) (computer technichian)))
		     ...
		     (assert! (can-do-job (computer wizard) (computer technichian)))
